const properties = [
    {
        id: 1,
        imgURL: 'https://postimg.cc/8fkxnbpZ',
        title: 'For Rent',
    ...
    {
        id: 2,
        imgURL: 'https://postimg.cc/pyyZk7xg',
        title: 'For Rent',
    ...
    {
        id: 3,
        imgURL: 'https://postimg.cc/0M1CQ5hm',
        title: 'For Rent',
    ...
    {
        id: 4,
        imgURL: 'https://postimg.cc/68DxcS8c',
        title: 'For Rent',
    ...
    {
        id: 5,
        imgURL: 'https://postimg.cc/gXm5BPmV',
        title: 'For Rent',
        descr: 'Comfortable Apartment',
        amount: '$1,600/mo',
        beds: 4,
    ...
    {
        id: 6,
        imgURL: 'https://postimg.cc/NLVDKwSd',
        title: 'For Rent',
        descr: 'Complex',
        amount: '$5,600/mo',
        beds: 5,
    ...
    {
        id: 7,
        imgURL: 'https://postimg.cc/t7LdXNnf',
        title: 'For Rent',
    ...
    {
        id: 8,
        imgURL: 'https://postimg.cc/MMnRwn6q',
        title: 'For Rent',
    ...
    {
        id: 9,
        imgURL: 'https://postimg.cc/PCfChCy9',
        title: 'For Rent',
    ...
    {
        id: 10,
        imgURL: 'https://postimg.cc/SXy7BQYx',
        title: 'For Rent',
...
const propertyContainer = document.getElementById('propertyList');
    ...
    properties.forEach(e => {
        ...
        <h5>${e.descr}</h5>
        <h6>${e.amount}</h6>
        <h6>${e.beds}<i class="fa-solid fa-bed"></i></h6>
        <h6>${e.bathroom}<i class="fa-solid fa-bath"></i></h6>
        <h6>${e.cars}<i class="fa-solid fa-car"></i></h6>
        <h6>${e.size}</h6>
        </li>`
    });
